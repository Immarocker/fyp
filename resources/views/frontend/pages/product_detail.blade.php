																	...
																	<div class="col-lg-12 col-12">
																		<div class="rating_box">
																			<div class="star-rating">
																				...
																				<input type="hidden" name="productslug" value="{{$product_detail->slug}}">
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist"  href="{{route('add-to-wishlist',$data->slug)}}"><i class=" ti-heart "></i><span>Add to
																			Wishlist</span></a>
			...
			<div class="modal-body">
				<div class="row no-gutters">
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
						<div class="product-gallery">
							<div class="quickview-slider-active"></div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
...
<script>
	$(document).ready(function () {
		$('.quick-view').on('click', function () {
			...
			$('#modelExample .quickview-content h2').text(title);
			$('#modelExample .quickview-content h3').text('Rs' + price);
			$('#modelExample .quickview-peragraph p').text(description);


			var imageHtml = '';
			$.each(images, function (index, image) {
				imageHtml += '<div class="single-slider"><img src="' + image + '" alt="#"></div>';
			});
			$('#modelExample .quickview-slider-active').html(imageHtml);
			...
			$('#modelExample select[name="size"]').html(sizeOptions);

			var colorOptions = '';
			$.each(colors, function (index, color) {
				colorOptions += '<option>' + color + '</option>';
			});
			$('#modelExample select[name="color"]').html(colorOptions);
		});
	});
