          ...
          <tbody>
            @foreach($brands as $brand)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('author.edit',$brand->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                        <form method="POST" action="{{route('author.destroy',[$brand->id])}}">
                          @csrf 
                          @method('delete')
