                            ...
                            @foreach($recent_products as $product)
                                                        ...
                                                        <div class="single-post first">
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                @endphp
                                                                <p class="price"><del
                                                                        class="text-muted">Rs{{number_format($product->price, 2)}}</del>
                                                                    Rs{{number_format($org, 2)}} </p>
                                                                        ...
                                                                        <div class="product-img">
                                                                            ...
                                                                            <div class="button-head">
                                                                                ...
                                                                                <div class="product-action-2">
                                                                                    <a title="Add to cart" href="{{route('add-to-cart', $product->slug)}}">Add
                                                                                        to
                                                                                        cart</a>
                                                                                </div>
                                                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row no-gutters">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 d-flex justify-content-center align-items-center">
                                <!-- Product Slider -->
                                <div class="product-gallery">
                                    <div class="quickview-slider-active">
                                        @php
                                            $photos = explode(',', $product->photo); // Properly splitting the photo string
                                        @endphp
                                        @foreach($photos as $data)
                                            <div class="single-slider">
                                                <img src="{{$data}}" alt="{{$product->title}}" class="img-fluid">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        ...
                                        <div class="quickview-stock">
                                            ...
                                            @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} out of
                                                    stock</span>
                                            @endif
                                        </div>
                                    </div>
