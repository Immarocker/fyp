                ...
                <div class="product-info">
                    <div class="nav-main">
                        ...
                        <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                            @php
                            $categories=DB::table('categories')->where('status','active')->where('is_parent',1)->limit(6)->get();
                            // dd($categories);
                            @endphp
                            @if($categories)
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    ...
                                    <div class="button-head">
                                        <div class="product-action">
                                            <a data-toggle="modal" data-target="#product-modal-{{$product->id}}"
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-detail', $product->slug) }}"
                                            style="font-weight: bold;">{{ $product->title }}</a></h3>
...
<script>
$(document).on('click', '.product-action a[data-toggle="modal"]', function() {
